...
const songs = [
    ...
    // all object type 
    {
        ...
        <div class="subtitle"> thunivu</div>`,
        poster: "img/3.jpg",
    },
    {
        id:"4",
        songName: ` Gangstaa <br>
        <div class="subtitle">thunivu</div>`,
        poster: "img/4.jpg",
    },
    {
        id:"5",
        songName: ` Azhaikadal <br>
        <div class="subtitle">ps-1</div>`,
        poster: "img/5.jpg",
    },
    {
        id:"6",
        songName: ` Ratchasa Mamane <br>
        <div class="subtitle">ps-1</div>`,
        poster: "img/6.jpg",
    },
    {
    ...
    {
        id:"8",
        songName: ` Master The Blaster <br>
        <div class="subtitle">master</div>`,
        poster: "img/8.jpg",
    },
    {
        id:"9",
        songName: ` jolly o gymkhana <br>
        <div class="subtitle">beast</div>`,
        poster: "img/9.jpg",
    },
    {
        id:"10",
        songName: ` Mayakama Kalakama <br>
        <div class="subtitle">thiruchitrapazham</div>`,
        poster: "img/10.jpg",
    },
    {
        id:"11",
        songName: ` Kutty Story <br>
        <div class="subtitle">master</div>`,
        poster: "img/11.jpg",
    },
    {
        id:"12",
        songName: ` Vaa Thalaivaa <br>
        <div class="subtitle">varisu</div>`,
        poster: "img/12.jpg",
    },
    {
    ...
    {
        id:"14",
        songName: ` Megam Karukadha <br>
        <div class="subtitle">thiruchitrapazham</div>`,
        poster: "img/14.jpg",
    },
    {
        id:"15",
        songName: ` Vathi Raid <br>
        <div class="subtitle">master</div>`,
        poster: "img/15.jpg",
    },
]
...
music.addEventListener('ended', ()=>{
    ...
    download_music.href = `audio/${index}.mp3`;
    poster_master_play.scr = 'img/${index}.jpg';
    music.play();
    let song_title = songs.filter((ele)=> {
        return ele.id ==index;
    })
